...
class Webservice {
    ...
    func getBdData(_ completion: @escaping ((Result<[BreakingBadCharacter], ResponseError>) -> Void)) {
        get(endpoint: BreakingBadAPIEndpoint.breakingBad(), decodingType: [BreakingBadCharacter].self, completion)
    }
}
